...
/**
 * Adds a middleware to use after a route.
 * @param middleware The middleware function to use.
 */
export function UseAfter(middleware: ICanBeMiddleware): MethodDecorator & ClassDecorator {
    return (target: Object | Function, propertyKey?: string | symbol, descriptor?: PropertyDescriptor) => {
        ...
        if(propertyKey) {
            ...
            handler.afterMiddlewares.unshift(middleware); // Unshift because decorators are applied bottom-up.
            ...
            metadata.afterMiddlewares.unshift(middleware); // Unshift because decorators are applied bottom-up.
            return void 0;
        }
